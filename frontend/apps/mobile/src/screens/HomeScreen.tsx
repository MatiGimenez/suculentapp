// Home / Dashboard — saludo, tareas del día con "Listo", CTA del reconocedor
// y plantas recientes. Pantalla de referencia construida 100% con el design
// system (@suculentapp/ui): mismo código de UI que la web.
